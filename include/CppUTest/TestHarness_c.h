...
#define CHECK_EQUAL_C_REAL(expected, actual, threshold)                        \
    CHECK_EQUAL_C_REAL_LOCATION(expected, actual, threshold, NULL, __FILE__,   \
                                __LINE__)

#define CHECK_EQUAL_C_REAL_TEXT(expected, actual, threshold, text)             \
    CHECK_EQUAL_C_REAL_LOCATION(expected, actual, threshold, text, __FILE__,   \
                                __LINE__)
...
#define CHECK_EQUAL_C_MEMCMP(expected, actual, size)                           \
    CHECK_EQUAL_C_MEMCMP_LOCATION(expected, actual, size, NULL, __FILE__,      \
                                  __LINE__)

#define CHECK_EQUAL_C_MEMCMP_TEXT(expected, actual, size, text)                \
    CHECK_EQUAL_C_MEMCMP_LOCATION(expected, actual, size, text, __FILE__,      \
                                  __LINE__)

#define CHECK_EQUAL_C_BITS(expected, actual, mask)                             \
    CHECK_EQUAL_C_BITS_LOCATION(expected, actual, mask, sizeof(actual), NULL,  \
                                __FILE__, __LINE__)

#define CHECK_EQUAL_C_BITS_TEXT(expected, actual, mask, text)                  \
    CHECK_EQUAL_C_BITS_LOCATION(expected, actual, mask, sizeof(actual), text,  \
                                __FILE__, __LINE__)
...
extern void CHECK_EQUAL_C_UINT_LOCATION(unsigned int expected,
                                        unsigned int actual, const char *text,
                                        const char *fileName,
                                        size_t lineNumber);
...
extern void CHECK_EQUAL_C_ULONG_LOCATION(unsigned long expected,
                                         ...
                                         const char *fileName,
                                         size_t lineNumber);
extern void CHECK_EQUAL_C_LONGLONG_LOCATION(cpputest_longlong expected,
                                            cpputest_longlong actual,
                                            const char *text,
                                            const char *fileName,
                                            size_t lineNumber);
extern void CHECK_EQUAL_C_ULONGLONG_LOCATION(cpputest_ulonglong expected,
...
extern void CHECK_EQUAL_C_BITS_LOCATION(unsigned int expected,
                                        unsigned int actual, unsigned int mask,
...
extern char *cpputest_strdup_location(const char *str, const char *file,
                                      size_t line);
extern char *cpputest_strndup_location(const char *str, size_t n,
                                       const char *file, size_t line);
extern void *cpputest_calloc_location(size_t num, size_t size, const char *file,
                                      size_t line);
